			...
			<div class="row">
				...
				<!-- <div class="col-xs-10 text-right menu-1">
					<ul>
                        ...
                        <li><a href="createNewUser.html">Create New Account</a></li>
				...
				<div class="col-md-7 text-left">
					<div class="display-t">
						<div class="display-tc animate-box" data-animate-effect="fadeInUp">
							<h1 class="mb30">Need some help with your tasks?</h1>
							<p>
								<a href="welcome.php" class="btn btn-primary">Get Started</a>
							</p>
						</div>
					</div>
				</div>
			...
			<div class="row row-pb-md">
				<div class="col-md-8 col-md-offset-2 text-left animate-box" data-animate-effect="fadeInUp">
					<div class="fh5co-heading">
						...
						<h2>How it Works</h2>
						<p>Getting swamped, or in need of cash? Have no fear.</p>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-4 col-sm-6 ">
					<div class="feature-center animate-box" data-animate-effect="fadeInUp">
						...
						<h3>Consolidation</h3>
						<p>All tasks are displayed. <br>Users can create their own.</p>
					</div>
				</div>
				<div class="col-md-4 col-sm-6 ">
					<div class="feature-center animate-box" data-animate-effect="fadeInUp">
						...
						<h3>Bidding Feature</h3>
						<p>Bid on the tasks you want to complete, and get paid for it at the end!</p>
					</div>
				</div>
				...
				<div class="col-md-4 col-sm-6 ">
					<div class="feature-center animate-box" data-animate-effect="fadeInUp">
						...
						<h3>User-Driven</h3>
						<p>Tasks are submitted by users, for users. <br>Users are the priority.</p>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-md-4 col-sm-4 animate-box" data-animate-effect="fadeIn">
					<div class="fh5co-staff">
						<img src="images/Daniel.jpg" alt="Free HTML5 Templates by gettemplates.co">
						<h3>Tan Joon Kai, Daniel</h3>
						<strong class="role">Back-end Developer</strong>
						<p>Bachelor of Computer Science <br>National University of Singapore</p>
					</div>
				</div>
				<div class="col-md-4 col-sm-4 animate-box" data-animate-effect="fadeIn">
					<div class="fh5co-staff">
						<img src="images/Pearlissa.jpeg" alt="Free HTML5 Templates by gettemplates.co">
						<h3>Pearlissa Taim Qi Yah</h3>
						<strong class="role">Front-end Developer</strong>
						<p>Bachelor of Information Security <br>National University of Singapore</p>
					</div>
				</div>
				<div class="col-md-4 col-sm-4 animate-box" data-animate-effect="fadeIn">
					<div class="fh5co-staff">
						<img src="images/Zheng_Kai.jpg" alt="Free HTML5 Templates by gettemplates.co">
						<h3>Lim Zheng Kai</h3>
						<strong class="role">Back-end Developer</strong>
						<p>Bachelor of Computer Science <br>National University of Singapore</p>
					</div>
