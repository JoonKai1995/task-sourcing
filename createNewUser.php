...
if (isset($_POST['submit'])){
    ...
    $result1 = pg_query($db, 'SELECT MAX(user_id) FROM users');
    $old_uid = pg_fetch_result($result1, 0, 0);
    $new_uid = $old_uid + 1;
    $result2 = pg_query($db, "INSERT INTO users values('$username', '$new_uid', '$password')");
    if (!$result2) {
                    ...
                    <div class="col-md-7 text-left">
                        <div class="display-t">
                            <div class="display-tc animate-box" data-animate-effect="fadeInUp">
                                ...
                                <form method="post" name="form" action="createNewUser.php">
